...
class TestIntegrationGithubOrgClient(unittest.TestCase):
    """Performs integration tests GithubOrgClient class."""
    
    @classmethod
    def setUpClass(cls) -> None:
        """Sets up class fixtures before running tests."""
        cls.org_payload = {"organization_data": "your_org_data"}
        cls.repos_payload = {"repos_data": "your_repos_data"}
        cls.expected_repos = {"expected_repos": "your_expected_repos"}
        cls.apache2_repos = {"apache2_repos": "your_apache2_repos"}
    ...
    def test_public_repos(self) -> None:
        """Tests public_repos method without specifying a license."""
        # Arrange & Act
    ...
    def test_public_repos_with_license(self) -> None:
        """Tests public_repos method with a specified license."""
        # Arrange & Act
